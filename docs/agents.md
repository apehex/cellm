...
This document defines how LLM agents should interact with the repository.

The goal is to ensure consistent contributions across automated and human collaborators.
